...
function sendPaymentReminder($conn, $user_id, $payment_type, $amount, $due_date, $reference_id)
{
    ...
    $html_message = "
        ...
        <body>
            ...
            <p><a href='localhost/LuckyNest/guest/dashboard' class='button'>Make Payment Now</a></p>
...
function sendBookingDepositReminder($conn, $user_id, $amount, $check_in_date, $booking_id, $days_before)
{
    ...
    $html_message .= "
            ...
            <p><a href='localhost/LuckyNest/guest/dashboard' class='button'>Pay Deposit Now</a></p>
