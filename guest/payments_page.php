...
try {
    ...
    // 1. Belong to the current guest
    // 2. Have not been paid
    // 3. Either have a deposit amount that has paid OR the room doesn't require a deposit (room_type.deposit_amount = 0)
    ...
    // Get all bookings that require deposit payment first
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($paymentType == 'rent') {
        ...
        // Check if deposit is required and paid for this booking
        try {
